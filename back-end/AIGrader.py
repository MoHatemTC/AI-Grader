...
class AIGrader:
    ...
    def process_tasks(self, task_description, journey_name, scope_rubric, requirements_rubric, solution):
        ...
        scoring_requirements_task = Task(
            ...
            expected_output="A JSON Object as this {'quality_score': 0-100, 'quality_comment': 'feedback'}",
        ...
        scoring_scope_task = Task(
            ...
            expected_output="A JSON Object as this {'scope_score': 0-100, 'scope_comment': 'feedback'}",
